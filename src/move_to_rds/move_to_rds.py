...
def handler(event, context):
    ...
    with conn.cursor() as cur:
        ...
        cur.execute("create table IF NOT EXISTS NewsStories(title varchar(255) NOT NULL, description varchar(255), author varchar(255), date varchar(255), link varchar(255) NOT NULL, source varchar(255) NOT NULL, created_date DATE NOT NULL, PRIMARY KEY (link))")
